...
RR.CUTOFFS.eu.all = {
    top100Score = 3681,
    CHALLENGER  = { minScore = 3579, wingScore = 3630 },
    GRANDMASTER = { minScore = 3512, wingScore = 3540 },
    MASTER      = { minScore = 3400, wingScore = 3436 },
    DIAMOND     = { minScore = 3202, wingScore = 3283 },
    EMERALD     = { minScore = 3058, wingScore = 3117 },
    PLATINUM    = { minScore = 2791, wingScore = 2926 },
    GOLD        = { minScore = 2490, wingScore = 2662 },
    SILVER      = { minScore = 1002, wingScore = 1907 },
...
RR.CUTOFFS.eu.horde = {
    top100Score = 3681,
    CHALLENGER  = { minScore = 3528, wingScore = 3630 },
    GRANDMASTER = { minScore = 3485, wingScore = 3506 },
    MASTER      = { minScore = 3335, wingScore = 3410 },
    DIAMOND     = { minScore = 3221, wingScore = 3278 },
    EMERALD     = { minScore = 3069, wingScore = 3145 },
    PLATINUM    = { minScore = 2795, wingScore = 2914 },
    GOLD        = { minScore = 2490, wingScore = 2615 },
    SILVER      = { minScore = 1002, wingScore = 1907 },
    BRONZE      = { minScore =  310, wingScore =  574 },
    IRON        = { minScore =    1, wingScore =  169 },
}
...
RR.CUTOFFS.eu.alliance = {
    top100Score = 3681,
    CHALLENGER  = { minScore = 3621, wingScore = 3630 },
    GRANDMASTER = { minScore = 3579, wingScore = 3600 },
    MASTER      = { minScore = 3433, wingScore = 3506 },
    DIAMOND     = { minScore = 3302, wingScore = 3367 },
    EMERALD     = { minScore = 3128, wingScore = 3215 },
    PLATINUM    = { minScore = 2837, wingScore = 2959 },
    GOLD        = { minScore = 2490, wingScore = 2664 },
    SILVER      = { minScore = 1002, wingScore = 1907 },
    BRONZE      = { minScore =  310, wingScore =  574 },
    IRON        = { minScore =    1, wingScore =  169 },
}
...
RR.CUTOFFS.us.all = {
    top100Score = 3652,
    CHALLENGER  = { minScore = 3548, wingScore = 3595 },
    GRANDMASTER = { minScore = 3461, wingScore = 3500 },
    MASTER      = { minScore = 3341, wingScore = 3394 },
    DIAMOND     = { minScore = 3127, wingScore = 3212 },
    EMERALD     = { minScore = 3011, wingScore = 3055 },
    PLATINUM    = { minScore = 2734, wingScore = 2848 },
    GOLD        = { minScore = 2342, wingScore = 2613 },
    SILVER      = { minScore = 890, wingScore = 1675 },
    BRONZE      = { minScore =  310, wingScore =  503 },
    IRON        = { minScore =    1, wingScore =  167 },
}

RR.CUTOFFS.us.horde = {
    top100Score = 3652,
    CHALLENGER  = { minScore = 3452, wingScore = 3595 },
    GRANDMASTER = { minScore = 3411, wingScore = 3431 },
    MASTER      = { minScore = 3268, wingScore = 3339 },
    DIAMOND     = { minScore = 3146, wingScore = 3207 },
    EMERALD     = { minScore = 2983, wingScore = 3064 },
    PLATINUM    = { minScore = 2731, wingScore = 2833 },
    GOLD        = { minScore = 2342, wingScore = 2529 },
    SILVER      = { minScore = 890, wingScore = 1675 },
    BRONZE      = { minScore =  310, wingScore =  503 },
    IRON        = { minScore =    1, wingScore =  167 },
}
...
RR.CUTOFFS.us.alliance = {
    top100Score = 3652,
    CHALLENGER  = { minScore = 3582, wingScore = 3595 },
    GRANDMASTER = { minScore = 3539, wingScore = 3560 },
    MASTER      = { minScore = 3389, wingScore = 3464 },
    DIAMOND     = { minScore = 3260, wingScore = 3324 },
    EMERALD     = { minScore = 3087, wingScore = 3173 },
    PLATINUM    = { minScore = 2792, wingScore = 2918 },
    GOLD        = { minScore = 2342, wingScore = 2586 },
    SILVER      = { minScore = 890, wingScore = 1675 },
    BRONZE      = { minScore =  310, wingScore =  503 },
    IRON        = { minScore =    1, wingScore =  167 },
}
...
RR.CUTOFFS.all.all = {
    top100Score = 3681,
    CHALLENGER  = { minScore = 3566, wingScore = 3615 },
    GRANDMASTER = { minScore = 3491, wingScore = 3523 },
    MASTER      = { minScore = 3375, wingScore = 3418 },
    DIAMOND     = { minScore = 3171, wingScore = 3253 },
    EMERALD     = { minScore = 3038, wingScore = 3091 },
    PLATINUM    = { minScore = 2767, wingScore = 2893 },
    GOLD        = { minScore = 2428, wingScore = 2641 },
    SILVER      = { minScore = 955, wingScore = 1810 },
    BRONZE      = { minScore =  310, wingScore =  544 },
    IRON        = { minScore =    1, wingScore =  168 },
}

RR.CUTOFFS.all.horde = {
    top100Score = 3681,
    CHALLENGER  = { minScore = 3497, wingScore = 3616 },
    GRANDMASTER = { minScore = 3455, wingScore = 3475 },
    MASTER      = { minScore = 3308, wingScore = 3381 },
    DIAMOND     = { minScore = 3190, wingScore = 3249 },
    EMERALD     = { minScore = 3034, wingScore = 3112 },
    PLATINUM    = { minScore = 2769, wingScore = 2881 },
    GOLD        = { minScore = 2429, wingScore = 2580 },
    SILVER      = { minScore = 956, wingScore = 1812 },
    BRONZE      = { minScore =  310, wingScore =  545 },
    IRON        = { minScore =    1, wingScore =  168 },
}

RR.CUTOFFS.all.alliance = {
    top100Score = 3681,
    CHALLENGER  = { minScore = 3604, wingScore = 3615 },
    GRANDMASTER = { minScore = 3562, wingScore = 3583 },
    MASTER      = { minScore = 3414, wingScore = 3488 },
    DIAMOND     = { minScore = 3284, wingScore = 3349 },
    EMERALD     = { minScore = 3110, wingScore = 3197 },
    PLATINUM    = { minScore = 2818, wingScore = 2941 },
    GOLD        = { minScore = 2427, wingScore = 2631 },
    SILVER      = { minScore = 954, wingScore = 1807 },
    BRONZE      = { minScore =  310, wingScore =  544 },
    IRON        = { minScore =    1, wingScore =  168 },
}
