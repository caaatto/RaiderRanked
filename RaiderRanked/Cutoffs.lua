...
RR.CUTOFFS.eu.all = {
    top100Score = 2808,
    CHALLENGER  = { minScore = 2778, wingScore = 2852 },
    GRANDMASTER = { minScore = 2722, wingScore = 2745 },
    MASTER      = { minScore = 2675, wingScore = 2691 },
    DIAMOND     = { minScore = 2597, wingScore = 2639 },
    EMERALD     = { minScore = 2336, wingScore = 2480 },
    PLATINUM    = { minScore = 1876, wingScore = 2113 },
    GOLD        = { minScore = 1240, wingScore = 1486 },
...
RR.CUTOFFS.us.all = {
    top100Score = 2855,
    CHALLENGER  = { minScore = 2820, wingScore = 2888 },
    GRANDMASTER = { minScore = 2742, wingScore = 2767 },
    MASTER      = { minScore = 2678, wingScore = 2698 },
    DIAMOND     = { minScore = 2549, wingScore = 2622 },
    EMERALD     = { minScore = 2292, wingScore = 2395 },
    PLATINUM    = { minScore = 1745, wingScore = 2041 },
    GOLD        = { minScore = 1240, wingScore = 1360 },
    SILVER      = { minScore = 620, wingScore = 930 },
    BRONZE      = { minScore =  310, wingScore =  465 },
...
RR.CUTOFFS.us.horde = {
    top100Score = 2855,
    CHALLENGER  = { minScore = 2756, wingScore = 2888 },
...
RR.CUTOFFS.us.alliance = {
    top100Score = 2855,
    CHALLENGER  = { minScore = 2839, wingScore = 2888 },
...
RR.CUTOFFS.all.all = {
    ...
    MASTER      = { minScore = 2677, wingScore = 2695 },
    DIAMOND     = { minScore = 2572, wingScore = 2630 },
    EMERALD     = { minScore = 2313, wingScore = 2435 },
    PLATINUM    = { minScore = 1807, wingScore = 2075 },
    GOLD        = { minScore = 1240, wingScore = 1419 },
    SILVER      = { minScore = 620, wingScore = 930 },
    BRONZE      = { minScore =  310, wingScore =  465 },
